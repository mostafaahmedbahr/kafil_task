  ...
  Widget build(BuildContext context) {
    return  BlocProvider(
      create: (context) => ServicesCubit(
          getIt.get<ServicesRepoImpl>())..getAllPopularServicesData(),
      child: BlocConsumer<ServicesCubit , ServicesStates>(
        listener: (context , state){},
        builder: (context , state){
          if(state is GetAllPopularServicesDataSuccessState){
            return Padding(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ListView.separated(
                            ...
                            child: Column(
                              children: [
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: CachedNetworkImage(
                                        ...
                                        fit: BoxFit.cover,
                                        imageUrl: "${state.popularServicesModel.data![index].mainImage}",
                                    ...
                                    Positioned(
                                      ...
                                      child: Container(
                                        ...
                                        child:   Center(
                                          child: Text("\$${state.popularServicesModel.data![index].price}",
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      Text("${state.popularServicesModel.data![index].title}",
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              ...
                                              Text("${state.popularServicesModel.data![index].averageRating}",
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Text("${state.popularServicesModel.data![index].completedSalesCount}",
                      ...
                      itemCount: state.popularServicesModel.data!.length,
                    ),
                  ),
                ],
              ),
          ...
          else if(state is GetAllPopularServicesDataLoadingState){
            return Padding(
              padding: const EdgeInsets.all(20.0),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
